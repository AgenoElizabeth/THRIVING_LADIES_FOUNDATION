      ...
      <section id="gallery-section" className="py-16 md:py-24 px-4 md:px-6">
        <div className="container mx-auto max-w-7xl">
          ...
          <div className="columns-1 md:columns-2 lg:columns-3 xl:columns-4 gap-4 md:gap-6 space-y-4 md:space-y-6">
            ...
            <div onClick={() => openLightbox(6)} role="button" tabIndex={0} onKeyDown={(e) => (e.key === 'Enter' || e.key === ' ') && openLightbox(6)} className="break-inside-avoid relative group overflow-hidden rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 cursor-pointer">
              <div className="relative h-64">
                ...
                <div className="absolute bottom-4 left-4 right-4 text-white opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                  <h4 className="font-semibold text-sm">Modern Facilities</h4>
                  <p className="text-xs opacity-90">Safe learning environments</p>
                </div>
              </div>
            </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mt-12">
            <Button onClick={() => openLightbox(0)} className="bg-gradient-to-r from-primary to-secondary hover:from-primary/90 hover:to-secondary/90 text-white shadow-xl hover:shadow-2xl transition-all duration-300 rounded-full px-8 py-3 group">
  ...
  <div className="relative container mx-auto text-center max-w-5xl space-y-6">
    ...
    <div className="flex flex-col sm:flex-row gap-6 justify-center pt-8">
      ...
      <Button
        size="lg"
        variant="outline"
        className="border-2 border-primary/50 text-primary hover:bg-white/20 bg-white/10 backdrop-blur-md shadow-xl hover:shadow-2xl transition-all duration-500 transform hover:scale-105 rounded-full px-10 py-4 text-lg group"
      >
