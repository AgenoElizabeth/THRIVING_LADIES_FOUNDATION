...
//              Thriving Ladies Foundation (TLF) is a Ugandan NGO committed to empowering vulnerable girls, women, and widows through integrated programs in education, economic empowerment, and environmental sustainability.
//             </p>
...
//                   <div className="text-4xl font-extrabold bg-gradient-to-r from-blue-600 to-cyan-600 bg-clip-text text-transparent">Community Impact</div>
...
//                 <div className="text-center">
//                   <div className="text-4xl font-extrabold bg-gradient-to-r from-green-600 to-emerald-600 bg-clip-text text-transparent">Pupils Empowered</div>
...
//   <div className="container mx-auto max-w-7xl flex flex-wrap gap-6 justify-center">
...
//                      dark:from-gray-800 dark:via-blue-900/20 dark:to-cyan-900/20 
//                      backdrop-blur-sm transform hover:scale-105 flex flex-col">
      
//       {/* Animated glow overlay */}
//       <div className="absolute inset-0 bg-gradient-to-br from-blue-400/10 via-cyan-400/10 to-green-400/10 
//                       opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>

//       <CardHeader className="relative z-10 pb-6 text-center">
//         <div className="w-20 h-20 bg-gradient-to-br from-blue-500 via-cyan-500 to-green-500 
//                         rounded-3xl flex items-center justify-center mb-6 
//                         group-hover:scale-110 group-hover:rotate-12 transition-all duration-300 shadow-xl">
//           <Rocket className="h-10 w-10 text-white animate-pulse" />
//         </div>
//         <CardTitle className="text-2xl md:text-3xl font-extrabold bg-gradient-to-r from-blue-600 to-cyan-600 
//                               bg-clip-text text-transparent">
//           The Challenge in Busoga
//         </CardTitle>
//       </CardHeader>

//       <CardContent className="relative z-10 flex-grow">
//         <CardDescription className="text-base md:text-lg leading-relaxed text-gray-700 dark:text-gray-300 font-medium mb-6">
//           The Busoga sub-region faces persistent challenges including high levels of poverty, 
//           school dropout among girls due to lack of menstrual hygiene facilities, and 
//           environmental degradation affecting livelihoods.
//         </CardDescription>

//         <div className="flex flex-wrap gap-3 justify-center">
//           <span className="px-4 py-2 bg-gradient-to-r from-blue-500 to-cyan-500 text-white rounded-full text-sm font-bold shadow-lg">Poverty</span>
//           <span className="px-4 py-2 bg-gradient-to-r from-cyan-500 to-green-500 text-white rounded-full text-sm font-bold shadow-lg">School Dropout</span>
//           <span className="px-4 py-2 bg-gradient-to-r from-green-500 to-emerald-500 text-white rounded-full text-sm font-bold shadow-lg">Environmental Challenges</span>
//         </div>
//       </CardContent>
//     </Card>
...
//       <CardHeader className="relative z-10 pb-6 text-center">
//         <div className="w-20 h-20 bg-gradient-to-br from-green-500 via-emerald-500 to-teal-500 
//                         rounded-3xl flex items-center justify-center mb-6 
//                         group-hover:scale-110 group-hover:-rotate-12 transition-all duration-300 shadow-xl">
//           <Rocket className="h-10 w-10 text-white animate-pulse" />
//         </div>
//         <CardTitle className="text-2xl md:text-3xl font-extrabold bg-gradient-to-r from-green-600 to-emerald-600 
//                               bg-clip-text text-transparent">
//           Geographic Focus
//         </CardTitle>
//       </CardHeader>
...
//       <CardContent className="relative z-10 flex-grow">
//         <CardDescription className="text-base md:text-lg leading-relaxed text-gray-700 dark:text-gray-300 font-medium mb-6">
//           TLF currently operates in the Busoga sub-region, Eastern Uganda, which comprises 11 districts and has a population of over 4.4 million people, making it the country's second largest sub-region.
//         </CardDescription>

//         <div className="flex flex-wrap gap-3 justify-center">
//           <span className="px-4 py-2 bg-gradient-to-r from-blue-500 to-cyan-500 text-white rounded-full text-sm font-bold shadow-lg">Busoga</span>
//           <span className="px-4 py-2 bg-gradient-to-r from-cyan-500 to-green-500 text-white rounded-full text-sm font-bold shadow-lg">Eastern Uganda</span>
//           <span className="px-4 py-2 bg-gradient-to-r from-green-500 to-emerald-500 text-white rounded-full text-sm font-bold shadow-lg">11 Districts</span>
//         </div>
//       </CardContent>
//     </Card>
...
//                 description: "Our Menstrual Hygiene Management (MHM) programs aim to reduce school absenteeism among pupils.",
//                 icon: Users,
...
export default function AboutPage() {
  ...
  const [selectedMember, setSelectedMember] = useState<any>(null)
  const [scrollY, setScrollY] = useState(0)
  const autoplay = useRef(Autoplay({ delay: 4000, stopOnInteraction: false, playOnInit: true }) as unknown as any).current
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-green-50 to-cyan-50 dark:from-gray-900 dark:via-blue-900/20 dark:to-green-900/20 overflow-x-hidden">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            ...
            <div className="space-y-8">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {[
                  { title: "High Dropout Rates", desc: "Affecting both boys and girls due to inadequate resources and menstrual hygiene facilities.", icon: BookOpen },
                  ...
                  { title: "Widespread Poverty", desc: "Especially in women-headed households and widows with limited income.", icon: TrendingUp }
                ].map((item, idx) => (
      ...
      {/* Team Section */}
      <section id="team" className="py-20 px-6 bg-gradient-to-br from-cyan-50 via-blue-50 to-green-50 dark:from-gray-900 dark:via-cyan-900/10 dark:to-blue-900/10 relative overflow-hidden">
        {/* Animated Background Elements */}
        <div className="absolute top-0 left-0 w-96 h-96 bg-gradient-to-br from-cyan-400/20 to-blue-400/20 rounded-full blur-3xl animate-pulse" style={{ transform: `translateY(${scrollY * 0.5}px)` }}></div>
        <div className="absolute bottom-0 right-0 w-96 h-96 bg-gradient-to-br from-green-400/20 to-emerald-400/20 rounded-full blur-3xl animate-pulse delay-700" style={{ transform: `translateY(${scrollY * -0.3}px)` }}></div>
        <div className="container mx-auto max-w-7xl relative z-10">
          ...
          <div className="relative max-w-4xl mx-auto">
            <div className="relative rounded-3xl overflow-hidden shadow-2xl ring-4 ring-gray-300/50 dark:ring-gray-500/30">
              <Carousel plugins={[autoplay]} className="w-full">
                <CarouselContent>
                  {[
                    { src: "https://ik.imagekit.io/xjtx0zx5v/WhatsApp%20Image%202026-02-17%20at%2014.37.54%20(1).jpeg", caption: "Our Humble Beginnings" },
                    { src: "https://ik.imagekit.io/xjtx0zx5v/visit0.jpeg?updatedAt=1772033444850", caption: "Planning with Local Leaders" },
                    { src: "https://ik.imagekit.io/xjtx0zx5v/visit2.jpeg?updatedAt=1772033435794", caption: "Community Visits" },
                    { src: "https://ik.imagekit.io/xjtx0zx5v/visit11.jpeg?updatedAt=1772033443854", caption: "Listening to the Community" },
                    { src: "https://ik.imagekit.io/xjtx0zx5v/images/outreach1.jpeg", caption: "Reaching the Most Vulnerable" },
                    { src: "https://ik.imagekit.io/xjtx0zx5v/images/making.jpeg", caption: "Teaching Practical Skills" },
                    { src: "https://ik.imagekit.io/xjtx0zx5v/images/class1.jpeg", caption: "Transforming Classrooms" },
                    { src: "https://ik.imagekit.io/xjtx0zx5v/Visit4%20Group?updatedAt=1771502217978", caption: "Strength in Numbers" },
                    { src: "https://ik.imagekit.io/xjtx0zx5v/tree%20planting.png?updatedAt=1773835229181", caption: "Planting for the Future" },
                    { src: "https://ik.imagekit.io/xjtx0zx5v/images/distribution1.jpeg", caption: "Providing Tangible Support" },
                    { src: "https://ik.imagekit.io/xjtx0zx5v/images/happy1.jpeg", caption: "Where We Are Now: Empowered Communities" }
                  ].map((item, index) => (
                    <CarouselItem key={index}>
                      <div className="h-80 md:h-96 lg:h-[30rem] relative">
                         <Image
                           src={item.src}
                           alt={`Impact story ${index + 1}`}
                           fill
                         ...
                         <div className="absolute bottom-6 left-6 right-6 md:bottom-10 md:left-10 md:right-10 text-white">
                            <h3 className="text-xl md:text-3xl font-extrabold shadow-black drop-shadow-lg">{item.caption}</h3>
                         </div>
                      </div>
                    </CarouselItem>
                  ))}
                </CarouselContent>
                <CarouselPrevious className="left-4 bg-white/20 hover:bg-white/50 border-none text-white backdrop-blur-sm hidden md:flex" />
                <CarouselNext className="right-4 bg-white/20 hover:bg-white/50 border-none text-white backdrop-blur-sm hidden md:flex" />
              </Carousel>
            </div>
      ...
      {/* Core Values Section */}
      <section id="values" className="py-20 px-6 bg-gradient-to-br from-purple-50 via-pink-50 to-red-50 dark:from-gray-900 dark:via-purple-900/10 dark:to-pink-900/10">
        <div className="container mx-auto max-w-7xl">
          <div className="text-center mb-16">
            <div className="inline-flex items-center gap-3 bg-gradient-to-r from-purple-500/10 via-pink-500/10 to-red-500/10 rounded-full px-8 py-4 border-2 border-purple-300/30 dark:border-purple-500/30 shadow-lg backdrop-blur-sm mb-6">
              <Award className="h-5 w-5 text-purple-600 dark:text-purple-400 animate-pulse" />
